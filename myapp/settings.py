...
SECRET_KEY = 'django-insecure-gx#m!o#5@+5+-v(sxm%+$6m-aw)6x1a=#qx#y=#9vco==$=8@6'
...
ACCOUNT_USER_MODEL_USERNAME_FIELD = 'customer_xid'
ACCOUNT_AUTHENTICATION_METHOD = 'customer_xid'
...
SIMPLE_JWT = {
    ...
    'USER_ID_FIELD': 'customer_xid',
    'USER_ID_CLAIM': 'customer_xid',
